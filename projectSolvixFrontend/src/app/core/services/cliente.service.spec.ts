...
describe('ClienteService', () => {
  ...
  it('lista todos los clientes sin inventar búsqueda', () => {
    ...
    const req = http.expectOne('http://localhost:8080/api/v1/clientes?soloActivos=false');
  ...
  it('crea con POST', () => {
    ...
    const req = http.expectOne('http://localhost:8080/api/v1/clientes');
  ...
  it('edita con PUT', () => {
    ...
    const req = http.expectOne('http://localhost:8080/api/v1/clientes/2');
